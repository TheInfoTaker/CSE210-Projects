...
class StationaryBicycle : Activity
{
    ...
    public override string GetSummary()
    {
        return $"{base.GetSummary()}: Speed {Speed:F1} kph, Distance {GetDistance():F1} km, Peace: {GetPace():F1} min per km";
    }
...
class Swimming : Activity
{
    ...
    public override string GetSummary()
    {
        return $"{base.GetSummary()}: Distance {GetDistance():F1} km, Speed {GetSpeed():F1} min per km";
    }
